...
def stress_test(num_clients=1000, test_duration=120, sse_test_url="http://localhost:8000/events/", watcher_url="http://localhost:8000/events/", watch_interval=1, event_sender_method=event_sender, event_sender_args=("http://localhost:8000/send-event/", 1)):
